...
const CardCompact = ({
  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-lg w-full flex h-40 mb-5">
      {/* Picture, pet, parking and favoriate button */}
      ...
      <div className="w-2/3 p-4 flex flex-col justify-between">
        ...
        <div>
          <div className="flex justify-between items-start">
            ...
            {showFavoriteButton && (
              <button
                className="bg-white hover:bg-white/90 rounded-full p-1 cursor-pointer"
        ...
        <div className="flex justify-between items-center text-sm">
          ...
          <p className="text-base font-bold">
            ...
            <span className="text-gray-600 text-xs font-normal"> /mon</span>
          </p>
        </div>
      </div>
    </div>
