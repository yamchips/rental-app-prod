...
const Residence = () => {
  const { id } = useParams(); // id is property id
  ...
  const { data: leases, isLoading: leaseLoading } = useGetLeasesQuery(
  ...
  if (propertyLoading || leaseLoading || paymentsLoading) return <Loading />;
